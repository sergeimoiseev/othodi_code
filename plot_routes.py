...
# def add_points_to_basemap_plot(plt,base_map,added_points_param_list):
#     MIN_L_WIDTH=7
#     POINT_SIZE=2*MIN_L_WIDTH

#     if len(added_points_param_list)==0:
#         print("no points added to plot.")
#         return plt,base_map
#     coord_pairs = added_points_param_list[0]
#     annotes = added_points_param_list[1]
...
#     plt.annotate("annotes[0]", xy=(0,1), textcoords='axes fraction',bbox=dict(boxstyle="round", fc=(1.0, 0.7, 0.7)))
...
#     # plt.plot(x_all,y_all,ls='o',marker='o',ms=POINT_SIZE,lw=MIN_L_WIDTH,alpha=0.5,solid_capstyle='round',color='r')
#     return plt, base_map
